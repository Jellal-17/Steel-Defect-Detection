...
def real_time_inference(input_directory, output_directory, model_path):
...
input_dir = "real_time_images"  # Directory with input images
output_dir = "real_time_predictions"  # Directory to save predictions
model_file = "unet_model.pth"  # Path to the trained model

real_time_inference(input_dir, output_dir, model_file)
